...
extension DateFormater on String {
  String getDate() {
    ...
    DateFormat format = DateFormat('EEEE, MMM dd');
...
extension CustomColors on Colors {
  ...
  static Color invertedBackgroundColor(BuildContext context) {
    if (Theme.of(context).brightness == Brightness.light) {
      return const Color.fromRGBO(30, 30, 33, 1);
    } else {
      return lightList;
...
extension IterableExtension<T> on Iterable<T> {
  /// Returns a list that contains no duplicates based on the
